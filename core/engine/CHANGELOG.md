...
## [1.0.0-beta.13](https://github.com/gorules/zen/compare/zen-engine-v1.0.0-beta.12...zen-engine-v1.0.0-beta.13) (2026-08-07)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * zen-tmpl bumped from 1.0.0-beta.12 to 1.0.0-beta.13

## [1.0.0-beta.12](https://github.com/gorules/zen/compare/zen-engine-v1.0.0-beta.11...zen-engine-v1.0.0-beta.12) (2026-08-07)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * zen-tmpl bumped from 1.0.0-beta.11 to 1.0.0-beta.12
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * zen-tmpl bumped from 1.0.0-beta.6 to 1.0.0-beta.7
